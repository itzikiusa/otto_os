<script lang="ts">
  ...
  // Categories are kinds, not states: a neutral label + a kind icon, no hue.
...
{:else}
  <div class="tc-tab">
    ...
    <!-- ── Generate panel ───────────────────────────────────────────────────── -->
    <section class="tc-card gen-panel">
      <div class="gen-row">
        ...
        {#if cases.length > 0}
          <section class="category-section">
            <div class="cat-header">
              <span class="cat-label"><Icon name={CATEGORY_ICONS[cat]} size={12} /> {CATEGORY_LABELS[cat]}</span>
