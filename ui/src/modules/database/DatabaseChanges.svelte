...
<style>
  .changes{padding:16px;min-width:0;color:var(--text)}h2,h3,h4,p{margin:0 0 10px}.toolbar,.title,.actions{display:flex;align-items:center;gap:10px;flex-wrap:wrap}.toolbar>div{flex:1}.toolbar p,.hint,small{color:var(--text-dim);font-size:var(--fs-s)}.layout{display:grid;grid-template-columns:230px minmax(0,1fr);gap:16px;margin-top:16px}nav{border-right:1px solid var(--border);padding-right:12px;max-height:65vh;overflow:auto}nav button{display:block;width:100%;text-align:left;margin-bottom:6px;overflow-wrap:anywhere}nav span{display:block;margin-top:4px;font-size:var(--fs-xs);color:var(--text-dim)}nav button.active{border-color:var(--accent);background:var(--hover)}main{min-width:0;max-height:68vh;overflow:auto;padding-right:4px}label{display:flex;flex-direction:column;gap:5px;margin:10px 0;font-size:var(--fs-s)}input,textarea,select{width:100%;box-sizing:border-box;padding:8px;color:var(--text);background:var(--surface-2);border:1px solid var(--border);border-radius:5px}textarea{resize:vertical}.script,.approved-script{font-family:var(--font-mono,monospace);font-size:var(--fs-s)}.approved-script{padding:12px;white-space:pre-wrap;overflow-wrap:anywhere;background:var(--surface-2);border:1px solid var(--border);border-radius:6px;max-height:300px;overflow:auto}button{padding:7px 10px;cursor:pointer;border:1px solid var(--border);border-radius:5px;background:var(--surface-2);color:var(--text)}button:disabled{opacity:.45;cursor:default}.actions{margin:12px 0}.badge{font-size:var(--fs-xs);padding:3px 7px;background:var(--hover);border:1px solid var(--border);border-radius:12px}.targets{display:flex;gap:8px;flex-wrap:wrap;font-size:var(--fs-s)}.target-row{display:flex;gap:8px;align-items:end;flex-wrap:wrap}.target-row label{flex:1;min-width:130px}fieldset{border:1px solid var(--border);border-radius:6px;padding:10px}legend{font-size:var(--fs-s)}.error{padding:10px;border:1px solid var(--danger);border-radius:5px;white-space:pre-wrap;margin:10px 0;overflow-wrap:anywhere}article{border:1px solid var(--border);border-radius:6px;padding:12px;margin:8px 0}article .badge{margin-left:8px}article p{margin-top:8px}details{margin:12px 0;font-size:var(--fs-s)}details code{display:block;overflow-wrap:anywhere}.empty{padding:35px 10px;color:var(--text-dim)}@media(max-width:650px){.layout{grid-template-columns:1fr}nav{max-height:150px;border-right:0;border-bottom:1px solid var(--border);padding:0 0 8px}main{max-height:none}.changes{padding:10px}}
</style>
