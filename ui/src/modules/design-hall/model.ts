...
export const STUDIOS: readonly StudioInfo[] = [
  ...
  },
  {
    ...
    icon: 'layout',
    phase: 'ready',
    note: 'Site Studio: start from a template, edit sections on a live canvas at desktop, tablet and mobile widths, and export a static site themed by your brand kit.',
    roadmap: null,
    formats: ['otto-site'],
  },
  {
