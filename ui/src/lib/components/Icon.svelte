<script lang="ts" module>
  ...
  const paths = {
    ...
    function: 'M6.3 2.8c-1.2 0-1.6.6-1.6 1.8 0 1.3.1 1.9-1.2 2.2v.4c1.3.3 1.2.9 1.2 2.2 0 1.2.4 1.8 1.6 1.8M9.7 2.8c1.2 0 1.6.6 1.6 1.8 0 1.3-.1 1.9 1.2 2.2v.4c-1.3.3-1.2.9-1.2 2.2 0 1.2-.4 1.8-1.6 1.8',
    // ui chrome
    ...
    eyeOff: 'M2.5 3 13.5 13M6.2 6.3a1.8 1.8 0 0 0 2.5 2.5M4.6 4.8C2.9 5.9 1.5 8 1.5 8s2.5 4.5 6.5 4.5c1 0 1.9-.2 2.7-.6m1.9-1.4C13.7 9.4 14.5 8 14.5 8S12 3.5 8 3.5c-.5 0-1 .1-1.5.2',
    ...
    // cloud (AWS console)
    cloud: 'M5 12.5h6.5a2.5 2.5 0 0 0 .3-5 3.5 3.5 0 0 0-6.7-.8A3 3 0 0 0 5 12.5Z',
    ...
    shield: 'M8 2l5 2v4c0 3-2.2 5-5 6-2.8-1-5-3-5-6V4l5-2Zm-2 6 1.5 1.5L10.5 6.5',
    lock: 'M4.5 7.5h7a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-7a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1Zm1 0V5a2.5 2.5 0 0 1 5 0v2.5M8 10v1.5',
